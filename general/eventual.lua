...
function eventual.ELSE()
    ...
    eventual.nests[#eventual.nests] = eventual.AND(eventual.nests[#eventual.nests-1] or (#eventual.nests == 1),eventual.negate(eventual.notSkipped()))
end
